...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    if unique_location in hass.data[DOMAIN]:
      ...
      _LOGGER.info('An existing IMS weather coordinator already exists for this location. Using that one instead')  
    else:
      weather_coordinator = WeatherUpdateCoordinator(city, language, timedelta(minutes=ims_scan_Int), hass)
